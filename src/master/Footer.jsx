...
//     <footer
//       style={{
//         background: "linear-gradient(135deg, #2119bf, #0a0f6d)",
//         color: "#fff",
//       }}
//       className="pt-5"
//     >
    ...
    >
      <div className="container">
        <div className="row mb-5">
          ...
          <div className="col-md-3 mb-4">
            <h5 className="fw-bold mb-3">
              <span style={{ color: "#f6fe0df0", fontWeight: "bold" }}>Quick Links</span>
            </h5>
            <ul className="list-unstyled">
              {[
                { name: "Home", path: "/" },
          ...
          <div className="col-md-3 mb-4">
            <h5 className="fw-bold mb-3">
              <span style={{ color: "#e3fb0d", fontWeight: "bold" }}>Our Services</span>
            </h5>
            <ul className="list-unstyled">
              {[
                "Waste Collection",
          ...
          <div className="col-md-3 mb-4">
            <h5 className="fw-bold mb-3">
              <span style={{ color: "#f1f919", fontWeight: "bold" }}>Contact Us</span>
            </h5>
            <ul className="list-unstyled mb-3">
              <li>📍 Punjab, India</li>
              <li>📞 +91 1234567890</li>
