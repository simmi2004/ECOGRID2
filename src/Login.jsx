    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          backgroundImage: 'url("https://images.unsplash.com/photo-1501004318641-b39e6451bec6?w=1600&q=80")',
          backgroundSize: "cover",
          backgroundPosition: "center",
        }} />

        {/* Green-to-blue dark overlay */}
        <div style={{
          position: "absolute", inset: 0,
          background: "linear-gradient(135deg, rgba(5,46,22,0.9) 0%, rgba(29,78,216,0.65) 100%)",
        }} />
        ...
        <div className="left-panel" style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "48px" }}>
            <div style={{
              ...
              background: "linear-gradient(145deg, #15803d, #1d4ed8)",
              borderRadius: "12px",
            ...
            <div>
              <div style={{ fontSize: "1.2rem", fontWeight: "800", color: "#fff", letterSpacing: "-0.03em" }}>
                Eco<span style={{ color: "#22c55e" }}>Manage</span>
              </div>
              <div style={{ fontSize: "0.6rem", color: "rgba(255,255,255,0.45)", letterSpacing: "0.15em", textTransform: "uppercase" }}>
                Waste Solutions
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", gap: "32px", marginTop: "48px" }}>
            {[
              { num: "500+",  label: "Pickups" },
              { num: "1200+", label: "Customers" },
              { num: "20+",   label: "Areas" },
            ].map((s, i) => (
              <div key={i}>
                <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ textAlign: "center", color: "rgba(255,255,255,0.35)", fontSize: "0.78rem", margin: 0 }}>
              ...
              <span style={{ color: "#22c55e", cursor: "pointer" }}>Terms of Service</span>
              {" "}and{" "}
